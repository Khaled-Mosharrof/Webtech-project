...
<body>
	<form method="post" action="../controller/createCheck.php" enctype="multipart/form-data">
							...
							<table align="center">
								<tr>
									...
									<td rowspan="3" align="left">
										<Table>
											<tr>
												<td colspan="3" align="right"><img src="../elements/profile.png" width="100px" height="100px" > </td>
											</tr>
										</Table>
									</td>
								</tr>
